...
from researchpy.core.matrix_design import ModelMatrix, DesignMatrix
...
class EngineModel(DesignMatrix):
    """
    ...
    def __init__(self, formula_like, data={}, conf_level=0.95,
        ...
        self.ModelDesignSpec.family = family
        self.ModelDesignSpec.link = link
        self.ModelDesignSpec.solver_method = self.solver_options.method
        self.ModelDesignSpec.ci_level = conf_level
        ...
        self.CoefResults.term = self.ModelDesignSpec.model_terms.columns
    ...
    def _get_coefficient_results(self, na_rep: object = '', pretty_format=True, table_decimals=None,
        ...
        test_stat_name = "t" if self.ModelDesignSpec.family == "gaussian" else "z"
        ...
        column_map = self.ModelDesignSpec.model_terms.column_map  # orig col → cleaned col
        ...
        for term in self.ModelDesignSpec.model_terms.terms:
            term = self.ModelDesignSpec.model_terms[term]
...
class BaseModel(ModelMatrix):
    ...
    def __init__(self, formula_like, data={}, conf_level=0.95,
        ...
        self.ModelFit = ModelFit(
            ...
            ci_level = conf_level,
            dv_term_names = list(self.DV.model_spec.column_names),
    ...
    def __compute_confidence_intervals(self):
        ...
        for beta, se in zip(self.CoefResults.betas, self.CoefResults.std_error):
            ...
            try:
                lower, upper = scipy.stats.norm.interval(self.ModelFit.ci_level, loc=beta, scale=se)
                conf_int_lower.append(float(lower))
                conf_int_upper.append(float(upper))
    ...
    def _summary_coef_table(self, coef_df, width=78, table_decimals=None):
        ...
        test_stat_label = self._test_stat_name
        ci_col_name = f"{int(self.ModelFit.ci_level * 100)}% Conf. Interval"
