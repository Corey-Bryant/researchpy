...
def mean(
    ...
    *,
    ...
    iv : str or list of str, optional
        Independent variable name(s). Alias for ``by``.
    by : str or list of str, optional
        Grouping variable name(s).
...
def median(
    ...
    *,
    ...
    ...
    """
    def _median_scalar(arr):
        return numpy.nanmedian(arr)

    def _median_grouped(data_df, dv_col, groups, interactions, dec):
        return _grouped_via_iteration(
            data_df, dv_col, groups, interactions, dec,
